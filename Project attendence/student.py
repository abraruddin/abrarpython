...
class Student:
    def __init__(self,root):
        ...
        self.var_teacher=StringVar()
          ...
          # first img
        img=Image.open(r"C:\Project attendence\images\images (14).jpg")
        ...
        # second img
        img1=Image.open(r"C:\Project attendence\images\images (15).jpg")
        ...
        #third img
        img2=Image.open(r"C:\Project attendence\images\images (16).jpg")
        ...
        #bg img
        img3=Image.open(r"C:\Project attendence\images\images (5).jpg")
        ...
        img_left=Image.open(r"C:\Project attendence\images\images (17).jpg")
        ...
        dep_combo["values"]=("Select Departmant","Computer","IT","Civil","Mechnical")
        dep_combo.current(0)
        ...
        btn_frame.place(x=0,y=185,width=715,height=35)
       ...
       #Right label frame
        ...
        img_right=Image.open(r"C:\Project attendence\images\images (6).jpg")
    ...
    #=========== Function decration====================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_stu_name.get()=="" or self.var_std_id.get()=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
        else:
            try:
               conn=mysql.connector.connect(host="localhost",user="root",password="clash of clans",database="face-recognizer")
        ...
        if self.var_dep.get()=="Select Department" or self.var_stu_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    ...
                    if not Update:
                        return
                messagebox.showinfo("Success","Student detauls successfully update completed",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
            except Exception as es:
