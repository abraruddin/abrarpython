...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # first img
        img=Image.open(r"C:\Project attendence\images\images (2).jpg")
        ...
        # second img
        img1=Image.open(r"C:\Project attendence\images\images (3).jpg")
        ...
        #third img
        img2=Image.open(r"C:\Project attendence\images\images (4).jpg")
        ...
        # student button
        img4=Image.open(r"C:\Project attendence\images\images (6).jpg")
        ...
        b1_1.place(x=200,y=300,width=220,height=40)
         ...
         # Detect face button
        img5=Image.open(r"C:\Project attendence\images\images (7).jpg")
        ...
        img6=Image.open(r"C:\Project attendence\images\images (8).jpg")
        ...
        # Help face button
        img7=Image.open(r"C:\Project attendence\images\images (9).jpg")
        ...
        # Train face button
        img8=Image.open(r"C:\Project attendence\images\images (10).jpg")
        ...
        # Photos face button
        img9=Image.open(r"C:\Project attendence\images\images (11).jpg")
        ...
        img10=Image.open(r"C:\Project attendence\images\images (12).jpg")
        ...
        b1_1.place(x=800,y=580,width=220,height=40)
         ...
         # Exit face button
        img11=Image.open(r"C:\Project attendence\images\images (13).jpg")
